...
## IDIOMA DEL OUTPUT (OBLIGATORIO)
${langInstruction} - Escribe TODO el email en este idioma, independientemente del contexto.

Solo devuelve el email, sin explicaciones adicionales.`;
}
...
## IDIOMA DEL OUTPUT (OBLIGATORIO)
${langInstruction} - Escribe TODO el output en este idioma, independientemente del contexto.`;
}
...
## IDIOMA DEL OUTPUT (OBLIGATORIO)
${langInstruction} - Este es el idioma en que DEBES escribir el snippet, independientemente del idioma del contexto.`;
}
