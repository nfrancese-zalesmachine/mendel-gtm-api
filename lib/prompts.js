const { getIndustrySnippets } = require('./context');
...
function buildEmailPrompt({
  ...
  const industrySnippets = getIndustrySnippets(industry);
...
- Dolores tipicos: ${industrySnippets.pains.join(', ')}
- Clientes referencia: ${industrySnippets.reference}
...
Escribe un email que conecte la senal "${signal}" con el valor que Mendel puede aportar.` :
